  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-10">
      <div className="rounded-3xl border bg-white p-8">
        <h1 className="text-3xl font-semibold">Hợp tác kinh doanh</h1>
        <p className="text-zinc-600 mt-3 max-w-3xl">
          Trang hợp tác (template) theo cấu trúc Dh Foods: HORECA, Nhà máy/OEM,
          Quà tặng doanh nghiệp, Xuất khẩu, Nhà phân phối, Chuỗi siêu thị…
        </p>
